...
-- 3) Cantidad media vendida por producto
...
-- 11) Total de ventas de productos con 'o' en el nombre
SELECT SUM(total) AS total_con_o FROM ventas WHERE producto LIKE '%o%';

-- 12) Suma de ventas de productos que empiezan por 'M'
